...
describe('Testing Users', () => {
    describe('[GET] /users', () => {
        it('response statusCode 200 / findAll', () => {
            const findUser = users_model_1.default.findAll();
    ...
    describe('[GET] /users/:id', () => {
        it('response statusCode 200 / findOne', () => {
            const userId = 1;
            const findUser = users_model_1.default.findByPk(userId);
            const usersRoute = new users_route_1.default();
            const app = new app_1.default([usersRoute]);
    ...
    describe('[DELETE] /users/:id', () => {
        it('response statusCode 200 / deleted', () => {
            const userId = 1;
            const deleteUser = users_model_1.default.destroy({ where: { id: userId } });
            const usersRoute = new users_route_1.default();
            const app = new app_1.default([usersRoute]);
